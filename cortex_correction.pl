...
my $rc2 = qx{$c2};
my $c3 = "$stampy_bin -G $outdir/ref/stampy/REF $ref_fa";
my $rc3 = qx{$c3};
my $c4 = "$stampy_bin -g $outdir/ref/stampy/REF -H $outdir/ref/stampy/REF";
my $rc4 = qx{$c4};
...
my $c9 = "perl $poli_dir"."filter_cortex_vcf.pl $outdir/results/vcfs/output_k".$k."_wk_flow_I_RefCC_FINALcombined_BC_calls_at_all_k.raw.vcf";
my $rc9 = qx{$c9};
...
my $rc11 = qx{$c11};
my $c12 = "cat $ref_fa | $vcftools_dir"."/perl/"."vcf-consensus $outdir/results/vcfs/output_k".$k."_wk_flow_I_RefCC_FINALcombined_BC_calls_at_all_k.raw.vcf.filtered.gz > $outdir/poligraph_corrected.fa 2>$outdir/log_vcf_consensus_k$k.txt";
my $rc12 = qx{$c12};
